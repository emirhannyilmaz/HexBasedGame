...
int main() {
    ...
    GuiTexture guiTexture("Resources/Textures/apple.png", GL_RGBA, GL_RGBA, GL_UNSIGNED_BYTE, glm::vec2(-0.5f, 0.5f), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec2(0.25f, 0.25f));
